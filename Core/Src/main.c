...
/* Configure the peripherals common clocks */
  ...
  // HAL_UART_Transmit(&huart1, "start", 6, 10);
#define Step_1 0U
#define Step_2 16000U
#define Step_3 36000U
#define Step_4 79200U
//D9, D0, D10, D4
/*
  TIM2->CCR1 = Step_1;
  TIM2->CCR2 = Step_1;
 ...
 */
 ...
 HAL_ADC_Start(&hadc1);
 HAL_ADC_PollForConversion(&hadc1, 20);
 adcarr[2] = HAL_ADC_GetValue(&hadc1);
...
/*
 if(adcarr[0] != 0 || adcarr[1] != 0 || adcarr[2] !=0 || adcarr[3] != 0) {
 sprintf(arr,"1 : %6ld   2 : %6ld   3 : %6ld   4 : %6ld   \r\n", adcarr[0], adcarr[1], adcarr[2], adcarr[3]);
 HAL_UART_Transmit(&huart1, arr, sizeof(arr), 10);
 }
*/
  }
  /* USER CODE END 3 */
